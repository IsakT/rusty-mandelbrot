        ...
        for pixel_y in 0..height {
            ...
            for pixel_x in 0..width {
                ...
                */
                ...
                // Now we have what we need to perform the Mandelbrot set calculation:
                //   z * z + c
...
Examples, with some pseudo code:
  x = 0.40
  y = 0.91
  c_complex_number = (x+y)
  z_complex_number = (0+0)
  
  // Mandelbrot function: z = z * z + c
  ...
  // check if the new value of z has "escaped", i.e if the real or imaginary number of z is more than 2.0
  // The calculated value of z is simply its real and imaginary number summed together, 
  //   e.g. 0.40 + 0.91 = 1.31
  z = 0.40 + 0.91
  ...
  // New value of z is a complex number of (-2.24 -0.00). Since the real number (x axis) 
  ...
  // stop the loop and return the number of iterations it took.
...
fn num_of_mandelbrot_iters_before_escape(
    ...
    max_iterations: usize,
        ...
        for i in 0..=max_iterations {
            if z.re > escape_value || z.re < -escape_value
            || z.im > escape_value || z.im < -escape_value {
